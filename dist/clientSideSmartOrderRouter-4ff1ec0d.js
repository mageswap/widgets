...
import { Token, CurrencyAmount } from '@mageswap/sdk-core';
import { ChainId, StaticV2SubgraphProvider, UniswapMulticallProvider, OnChainQuoteProvider, AlphaRouter, routeAmountsToString } from '@mageswap/smart-order-router';
import { i as isExactInput, Q as QuoteState, S as SwapRouterNativeAssets, n as nativeOnChain } from './index-5f4e9800.js';
...
import '@mageswap/universal-router-sdk';
...
import 'jotai';
import '@mageswap/v2-sdk';
import '@mageswap/v3-sdk';
...
import '@mageswap/redux-multicall';
import '@ethersproject/address';
import '@ethersproject/constants';
import '@ethersproject/contracts';
import '@mageswap/permit2-sdk';
import '@mageswap/conedison/provider/signing';
import '@mageswap/conedison/format';
...
import 'qrcode';
import '@mageswap/conedison/provider/index';
...
function getRouter(chainId, provider) {
  ...
  if ([ChainId.POLYGON, ChainId.POLYGON_MUMBAI].includes(chainId)) {
    multicall2Provider = new UniswapMulticallProvider(chainId, provider, 375000);
...
//# sourceMappingURL=clientSideSmartOrderRouter-4ff1ec0d.js.map
