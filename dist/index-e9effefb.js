...
function formatElements(value) {
  ...
  var _iterator = _createForOfIteratorHelper$5(getElements(parts)),
    _step;
  try {
...
function Trans(props) {
  var _useLingui2 = useLingui(),
    i18n = _useLingui2.i18n,
    defaultComponent = _useLingui2.defaultComponent;
...
var _excluded$7 = ["target", "href", "rel"];
/**
 * Outbound link
 */
...
var _excluded$6 = ["icon", "iconProps"];
...
var BnbChainNativeCurrency = /*#__PURE__*/function (_NativeCurrency) {
  ...
  var _super = _createSuper$9(BnbChainNativeCurrency);
...
var MaticNativeCurrency = /*#__PURE__*/function (_NativeCurrency2) {
  ...
  var _super2 = _createSuper$9(MaticNativeCurrency);
...
var ExtendedEther = /*#__PURE__*/function (_Ether) {
  ...
  var _super3 = _createSuper$9(ExtendedEther);
...
var InterfaceTrade = /*#__PURE__*/function (_Trade) {
  ...
  var _super = _createSuper$8(InterfaceTrade);
...
var ParseError = /*#__PURE__*/function (_Error) {
  ...
  var _super = _createSuper$7(ParseError);
  /** @internal */
...
var defaultFormats = function defaultFormats(locale, locales) {
  ...
  var replaceOctothorpe = function replaceOctothorpe(value, message) {
    return function (ctx) {
      ...
      var valueStr = _number(locales, numberFormat)(value);
  ...
  return {
    ...
    number: function number(value, format) {
      return _number(locales, style(format))(value);
    },
    date: function date(value, format) {
      return _date(locales, style(format))(value);
    },
...
var I18n = /*#__PURE__*/function (_EventEmitter) {
  ...
  function I18n(params) {
    ...
    _this3._messages = {};
    _this3._localeData = {};
    if (params.missing != null) _this3._missing = params.missing;
    if (params.messages != null) _this3.load(params.messages);
    if (params.localeData != null) _this3.loadLocaleData(params.localeData);
    if (params.locale != null || params.locales != null) {
      _this3.activate(params.locale, params.locales);
    }
    return _this3;
  }
  _createClass(I18n, [{
    ...
    value: function loadLocaleData(localeOrAllData, localeData) {
      ...
      if (localeData != null) {
        ...
        Object.keys(localeOrAllData).forEach(function (locale) {
          return _this4._loadLocaleData(locale, localeOrAllData[locale]);
        });
      }
      this.emit("change");
    }
    ...
    value: function load(localeOrMessages, messages) {
      ...
      if (messages != null) {
        ...
        Object.keys(localeOrMessages).forEach(function (locale) {
          return _this5._load(locale, localeOrMessages[locale]);
        });
      }
      this.emit("change");
    }
    ...
    value: function date(value, format) {
      return _date(this._locales || this._locale, format)(value);
    }
  }, {
    key: "number",
    value: function number(value, format) {
      return _number(this._locales || this._locale, format)(value);
    }
  }]);
  return I18n;
}(EventEmitter);
          ...
          return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
            ...
            return _regeneratorRuntime.wrap(function _callee2$(_context2) {
              while (1) switch (_context2.prev = _context2.next) {
                ...
                case 28:
                  _context2.next = 30;
                  return import('./clientSideSmartOrderRouter-0610d995.js');
                case 30:
          ...
          return _regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              ...
              case 8:
                ...
                throw new Error( /*i18n*/i18n._("Unexpected error. Could not estimate gas for the swap."));
              case 11:
