...
var smartOrderRouter = require('@mageswap/smart-order-router');
var index = require('./index-c8d5868a.cjs');
...
function getRouter(chainId, provider) {
  ...
  if ([smartOrderRouter.ChainId.POLYGON, smartOrderRouter.ChainId.POLYGON_MUMBAI].includes(chainId)) {
    multicall2Provider = new smartOrderRouter.UniswapMulticallProvider(chainId, provider, 375000);
