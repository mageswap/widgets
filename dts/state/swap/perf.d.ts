...
import { ApprovalTransactionInfo, SwapTransactionInfo, UnwrapTransactionInfo, WrapTransactionInfo } from 'state/transactions';
/**
 ...
 */
export type OnTokenAllowance = (args: {
    token: Token;
    spender: string;
 ...
 */
export type OnPermit2Allowance = (args: {
    token: Token;
    spender: string;
