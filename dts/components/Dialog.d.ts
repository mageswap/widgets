...
export declare function Provider({ value, children, options }: ProviderProps): JSX.Element;
...
export declare function Header({ title, closeButton }: HeaderProps): JSX.Element;
