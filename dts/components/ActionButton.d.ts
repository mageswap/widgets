...
export default function ActionButton({ color, disabled, shouldUseDisabledColor, action, onClick, children, wrapperProps, narrow, ...rest }: ActionButtonProps): JSX.Element;
export {};
