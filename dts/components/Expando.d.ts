...
export default function Expando({ title, iconPrefix, open, onExpand, height, maxHeight, children, styledWrapper, ...rest }: PropsWithChildren<ExpandoProps>): JSX.Element;
export {};
