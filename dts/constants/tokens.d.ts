import { Ether, NativeCurrency, Token } from '@mageswap/sdk-core';
...
export declare const USDC_FANTOM_CHAIN: Token;
export declare const USDC_CANTO_CHAIN: Token;
export declare const USDC_ZKSYNC_CHAIN: Token;
export declare const USDC_AVAX_CHAIN: Token;
